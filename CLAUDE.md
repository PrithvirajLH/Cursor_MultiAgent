...
**206 unit tests (26 suites), 380 integration + 1 skipped, 36 web unit tests (13 files)**, both typechecks clean.

```bash
cd apps/api && npx tsc --noEmit
cd apps/web && npx tsc --noEmit
cd apps/api && npx jest                       # 206, 26 suites
...
cd apps/api && npm run test:integration       # 380 + 1 skipped, takes ~6-10 min
```
