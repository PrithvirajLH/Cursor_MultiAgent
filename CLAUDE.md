...
**222 unit tests (28 suites), 395 integration + 1 skipped, 36 web unit tests (13 files)**, both typechecks clean.

```bash
cd apps/api && npx tsc --noEmit
cd apps/web && npx tsc --noEmit
cd apps/api && npx jest                       # 222, 28 suites
...
cd apps/api && npm run test:integration       # 395 + 1 skipped, takes ~6-10 min
```
