...
**227 unit tests (28 suites), 401 integration + 1 skipped, 36 web unit tests (13 files)**, both typechecks clean.

```bash
cd apps/api && npx tsc --noEmit
cd apps/web && npx tsc --noEmit
cd apps/api && npx jest                       # 227, 28 suites
...
cd apps/api && npm run test:integration       # 401 + 1 skipped, takes ~6-10 min
```
