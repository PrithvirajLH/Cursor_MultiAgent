...
**519 unit tests (51 suites), 699 integration + 1 skipped, 212 web unit tests (32 files)**, both typechecks clean.

```bash
cd apps/api && npx tsc --noEmit
cd apps/web && npx tsc --noEmit
cd apps/api && npx jest                       # 519, 51 suites
cd apps/web && npx vitest run                 # 212, 32 files
