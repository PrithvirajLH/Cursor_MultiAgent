...
**468 unit tests (47 suites), 560 integration + 1 skipped, 143 web unit tests (25 files)**, both typechecks clean.
...
cd apps/api && npm run test:integration       # 560 + 1 skipped, takes ~6-10 min
```
