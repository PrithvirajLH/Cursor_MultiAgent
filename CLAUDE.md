...
**206 unit tests (26 suites), 388 integration + 1 skipped, 36 web unit tests (13 files)**, both typechecks clean.
...
cd apps/api && npm run test:integration       # 388 + 1 skipped, takes ~6-10 min
```
