...
**206 unit tests (26 suites), 374 integration + 1 skipped, 36 web unit tests (13 files)**, both typechecks clean.
...
cd apps/api && npm run test:integration       # 374 + 1 skipped, takes ~5-6 min
```
