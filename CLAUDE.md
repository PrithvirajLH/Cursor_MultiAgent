...
**344 unit tests (39 suites), 446 integration + 1 skipped, 70 web unit tests (18 files)**, both typechecks clean.

```bash
cd apps/api && npx tsc --noEmit
cd apps/web && npx tsc --noEmit
cd apps/api && npx jest                       # 344, 39 suites
...
cd apps/api && npm run test:integration       # 446 + 1 skipped, takes ~6-10 min
```
