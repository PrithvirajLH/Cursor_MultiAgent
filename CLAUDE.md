...
**186 unit tests, 360 integration + 1 skipped, 36 web unit tests (13 files)**, both typechecks clean.
...
cd apps/api && npm run test:integration       # 360 + 1 skipped, takes ~6 min
```
