      ...
      <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
        ...
        {secondaryAction && (
          <button
            ...
            className="rounded-lg border border-border bg-card px-4 py-2 text-sm font-medium text-foreground hover:bg-accent focus:outline-none focus:ring-2 focus:ring-ring/30 focus:ring-offset-2"
          >
