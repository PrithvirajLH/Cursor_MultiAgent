...
export function CommandPalette({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-start justify-center pt-[calc(15vh/var(--ui-zoom))] bg-black/60 backdrop-blur-sm"
      onClick={(e) => {
