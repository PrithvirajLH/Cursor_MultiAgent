...
| 1.2 Requester confirm / reopen / cancel | **Handoff written** (2026-08-27) | `prompts/2026-08-27-1-2-requester-confirm-reopen-cancel.md` | Decision taken by planner (owner unopposed): **`closeReason` enum column, no new CANCELLED status**. Small additive migration (50th). Owner asked to build 1.2 then deploy 1.1 + 1.2 together. |
