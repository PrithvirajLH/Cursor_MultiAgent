...
| 1.1 Edit ticket subject/description | **Handoff written** (2026-08-27) | `prompts/2026-08-27-1-1-edit-ticket-subject-description.md` | First Phase 1 card. Code only, no Azure cost, no migration. Merge on GREEN; **deploy** (feature). |
