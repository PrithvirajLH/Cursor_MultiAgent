...
**Last deploy:** 2026-08-28 22:59 UTC — cards 1.1, 1.2, 1.3, 1.4, 1.19 shipped as `2df679d` (deployment `4d2bc6e8`, status 4). Both migrations applied (51 total), six trigram indexes intact, bundle hash matched. **Outstanding:** §6 of `prompts/2026-08-28-deploy-cards-1-1-to-1-19.md` — the intake endpoint stays inert until the secret is set and the path is excluded from Easy Auth.
