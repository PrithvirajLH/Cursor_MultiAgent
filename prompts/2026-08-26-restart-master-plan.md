...
**1.30 Stage 1 — GREEN against `50fe7dc`** (naming the SHA, per the lesson from 1.29). Re-ran everything: api `tsc` 0, unit **463/46**, integration **504 + 1 skipped,
...
**Stage 2 deliberately not built**, which is correct: it needs a migration, that is the owner's call, and Stage 1's flagging is the evidence that should decide it. **The
