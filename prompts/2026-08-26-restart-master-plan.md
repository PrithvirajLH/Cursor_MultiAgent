...
**Last deploy:** 2026-08-28 22:59 UTC — cards 1.1, 1.2, 1.3, 1.4, 1.19 shipped as `2df679d` (deployment `4d2bc6e8`, status 4). Both migrations applied (51 total), six trigram indexes intact, bundle hash matched. **§6 completed 2026-08-28** — the intake endpoint is live and answering. **Outstanding:** card 1.20 fixes two defects in it before any flow is built.
