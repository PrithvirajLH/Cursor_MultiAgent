...
| 1.13 CSV export | **Handoff written; batched with 1.21** — combined kickoff `prompts/2026-08-31-1-13-and-1-21-combined.md` (2026-08-31) | `prompts/2026-08-30-1-13-csv-export.md` | Ticket list + report exports, streamed like the audit log; deletes the fake `helpdesk.local` share link (February's FE-09). Spreadsheet-injection escaping included. Half a day to a day. |
| 1.21 Operations console | **Handoff written; batched with 1.13** — combined kickoff `prompts/2026-08-31-1-13-and-1-21-combined.md` (2026-08-31). Do 1.13 first. | `prompts/2026-08-30-1-21-operations-console.md` | Admin → Operations, owner-only: three groups (switches / data in / jobs) and a jobs table with **Run now**, modelled on the LMS page the owner pointed at. Adds `runOnce()` to the SLA worker to match the other two. A few days. |
